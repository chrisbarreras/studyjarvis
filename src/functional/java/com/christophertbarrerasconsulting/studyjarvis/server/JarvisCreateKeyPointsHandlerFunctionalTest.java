...
public class JarvisCreateKeyPointsHandlerFunctionalTest {
    ...
    @Test
    public void createKeyPointsCreatesKeyPoints() throws IOException {
        Request request = client.postRequest("", "/secure/jarvis/create-key-points");
