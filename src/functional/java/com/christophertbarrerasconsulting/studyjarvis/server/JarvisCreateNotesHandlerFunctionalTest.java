...
public class JarvisCreateNotesHandlerFunctionalTest {
    ...
    @Test
    public void createNotesCreatesNotes() throws IOException {
        Request request = client.postRequest("", "/secure/jarvis/create-notes");
