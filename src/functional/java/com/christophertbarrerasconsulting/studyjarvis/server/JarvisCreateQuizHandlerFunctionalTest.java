...
public class JarvisCreateQuizHandlerFunctionalTest {
    ...
    @Test
    public void createQuizCreatesQuiz() throws IOException {
        Request request = client.postRequest("{\"numberOfQuestions\":5}", "/secure/jarvis/create-quiz");
